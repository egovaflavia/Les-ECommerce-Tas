    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <h5>Facebook : <i>romanindah.ukm</i></h5>
                <hr style="display: block; height: 1px;border: 0; border-top: 1px solid #ccc;margin: 1em 0; padding: 0;">
            </div>
        </div>
        <br>
        <h3 class="col-sm-12" align="center"><u>Laporan Data Penjualan <?php echo tgl_indo($hari)  ?></u></h3>
        <br>
        <br>
        <br>
        <div class="row">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            $hari = $_POST['hari'];
                            $ambil = $koneksi->query("SELECT * FROM `penjualan` LEFT JOIN pelanggan ON penjualan.id_pelanggan=pelanggan.id_pelanggan WHERE penjualan.status != 'Pending' AND penjualan.tgl_penjualan LIKE '$hari%' ");
